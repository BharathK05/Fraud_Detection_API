...
app = FastAPI(
    title="Fraud Shield",  
    description="API for detecting and managing fraudulent activities. \n\n**Created by: Niranjan B, Bharath K, Anto Jenicks J**",
    license_info={
        "name": "MIT License",
        "url": "https://github.com/BharathK05/Fraud_Detection_API/blob/main/LICENSE"
    },
    version="1.0.0"
)
